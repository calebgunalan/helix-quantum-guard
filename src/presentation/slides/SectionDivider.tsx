...
export default function SectionDivider({ number, title, subtitle }: Props) {
  return (
    <section data-transition="fade">
      <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-55%)', fontSize: '14em', fontWeight: 900, color: 'rgba(0,212,255,0.03)', lineHeight: 1, pointerEvents: 'none', userSelect: 'none' }}>
        {number}
      </div>
      <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
        ...
        <h2 style={{ fontSize: '1.8em', fontWeight: 700, marginBottom: '20px', textAlign: 'center' }}>{title}</h2>
