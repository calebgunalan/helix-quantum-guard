  ...
  return (
    <section data-auto-animate data-transition="slide">
      ...
      <div className="grid-2x3" style={{ marginTop: '24px', gap: '16px' }}>
        {achievements.map((a) => (
          <TiltCard key={a.title} className="fragment" maxTilt={8}>
            <div className="pres-card" style={{ padding: '20px', display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
      ...
      <aside className="notes">Six achievements, each representing a distinct technical contribution.</aside>
    </section>
  );
}
