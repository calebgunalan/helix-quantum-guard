    ...
    <section>
      ...
      <section data-transition="fade">
        ...
        <div className="grid-2" style={{ marginTop: '28px', gap: '32px' }}>
          <div className="pres-card" style={{ textAlign: 'center', padding: '32px', borderTop: '3px solid #dc2626' }}>
          ...
          <div className="pres-card" style={{ textAlign: 'center', padding: '32px', borderTop: '3px solid #16a34a' }}>
            <span style={{ fontSize: '3em' }}>🔐</span>
            <h3 style={{ fontSize: '1em', color: '#16a34a', margin: '16px 0 12px', textAlign: 'center' }}>CRYSTALS-Dilithium3</h3>
            <p style={{ fontSize: '0.72em', color: '#94a3b8', lineHeight: 1.6 }}>
      ...
      <section data-transition="fade">
        ...
        <div className="grid-2" style={{ marginTop: '28px', gap: '28px' }}>
          <div className="pres-card pres-card-teal" style={{ padding: '28px' }}>
            ...
            <div className="pres-badge" style={{ marginTop: '16px', fontSize: '0.6em' }}>128-bit post-quantum security</div>
          </div>
          <div className="pres-card pres-card-violet" style={{ padding: '28px' }}>
            ...
            <div className="pres-badge pres-badge-violet" style={{ marginTop: '16px', fontSize: '0.6em' }}>128-bit post-quantum security</div>
          </div>
        </div>
