  ...
  return (
    <section>
      ...
      <section data-auto-animate data-transition="fade">
        ...
        <aside className="notes">RSA collapses under quantum attack. Dilithium stays exponential.</aside>
      </section>
      ...
      <section data-auto-animate data-transition="fade">
        ...
        <aside className="notes">Dilithium proves who you are. Kyber protects the channel.</aside>
      </section>
    </section>
  );
}
